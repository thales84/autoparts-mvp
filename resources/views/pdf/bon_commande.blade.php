...
.header-doc-number { font-size:19px; font-weight:700; color:#60a5fa; font-family:monospace; text-align:right; margin-top:4px; }
.header-doc-date { font-size:9.5px; color:rgba(255,255,255,.6); text-align:right; margin-top:3px; }

/* ── Accent stripe + banner ── */
.accent-stripe { height:3px; background:#2563eb; }
.status-banner { background:#16a34a; color:#fff; text-align:center; padding:9px; font-size:11px; font-weight:700; letter-spacing:2px; text-transform:uppercase; }
...
.confirm-label { font-size:9px; font-weight:700; text-transform:uppercase; letter-spacing:1.2px; color:#16a34a; margin-bottom:5px; }
.confirm-amount { font-size:20px; font-weight:700; color:#15803d; }

/* ── Note info ── */
.note-info { border-left:3px solid #2563eb; background:#eff6ff; padding:10px 14px; margin-bottom:16px; font-size:10.5px; color:#1e3a5f; line-height:1.6; }
...
<div class="pdf-footer">
    ...
    <div class="footer-legal">
        ...
        <span class="footer-date">Document émis le {{ now()->format('d/m/Y à H:i') }} · Ce bon de commande confirme l'acceptation de votre commande et la réception du paiement</span>
    </div>
</div>
...
<table class="header-table">
    <tr>
        ...
        <td style="width:45%;text-align:right;">
            <div class="header-doc-label">Bon de Commande</div>
...
<div class="status-banner">✓ Commande confirmée — Paiement validé</div>
...
@endphp
    ...
    <table class="parties-table">
        <tr>
            ...
            <td style="width:48%;padding-left:8px;vertical-align:top;">
                <div class="party-box">
                    <div class="party-tag">Acheteur</div>
                ...
                <div class="summary-box">
                    <table class="summary-row-table">
                        ...
                        <tr class="sum-row-total">
                            <td>{{ $vatRegime === 'standard' ? 'MONTANT TTC' : 'MONTANT TOTAL' }}</td>
    ...
    <div class="confirm-box">
        <div class="confirm-label">Paiement reçu et validé</div>
        <div class="confirm-amount">{{ number_format($order->total, 2, ',', ' ') }} {{ $currency }}</div>
    </div>

    {{-- Note traitement --}}
    <div class="note-info">
        <strong>Votre commande est en cours de traitement.</strong>
        Nos équipes préparent votre commande et vous contacteront pour organiser la livraison ou le retrait en boutique.
        @if(!empty($settings['contact_whatsapp']) || !empty($settings['contact_email']))
            <br>Pour toute question :
    ...
    {{-- Notes client --}}
    @if($order->notes)
    <div style="background:#fefce8;border:1px solid #fde68a;border-radius:4px;padding:10px 14px;margin-bottom:16px;font-size:10px;color:#78350f;">

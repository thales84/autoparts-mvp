...
<div class="d-flex align-items-center gap-3 mb-4">
    ...
    <h1 class="fw-bold mb-0" style="font-size: 1.25rem;">Nouveau produit</h1>
</div>
            ...
            <div style="background: #fff; border: 1px solid var(--ap-border); border-radius: var(--ap-radius); padding: 1.5rem; margin-bottom: 1.25rem;">
                ...
                <div class="mb-0">
                    ...
                    <textarea name="compatibility_notes" rows="3"
                              ...
                              placeholder="Ex: Compatible Peugeot 206 (2000-2005), Citroën C3 phase 1...">{{ old('compatibility_notes') }}</textarea>
            ...
            <div style="background: #fff; border: 1px solid var(--ap-border); border-radius: var(--ap-radius); padding: 1.5rem;">
                ...
                <div class="mb-3">
                    ...
                    <select name="condition" class="form-select @error('condition') is-invalid @enderror">
                        <option value="used_good"    {{ old('condition', 'used_good') === 'used_good'    ? 'selected' : '' }}>Occasion — bon état</option>
                        <option value="used_fair"    {{ old('condition') === 'used_fair'    ? 'selected' : '' }}>Occasion — état correct</option>
                        <option value="refurbished"  {{ old('condition') === 'refurbished'  ? 'selected' : '' }}>Reconditionné</option>
                        <option value="for_parts"    {{ old('condition') === 'for_parts'    ? 'selected' : '' }}>Pour pièces</option>
                    </select>
